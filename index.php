<head>
    <BASE href="http://gochaabuladze.elasticbeanstalk.com/">
    <?php
...
<div id="main">
    ...
    <div class="fb-comments" colorscheme="dark" data-href="<?= rel2abs($_SERVER['REQUEST_URI']) ?>"
         data-numposts="5"></div>

</div>

<? include 'php/social_select.php' ?>
<div class="share-icons-sidebar">
    <? include 'php/social_icons.php' ?>
</div>
...
<footer>
    ...
    <div
        style="position:relative;display:block;margin:0 auto;padding:0px;width:100%;max-width:980px;height:60px;line-height:60px;font-size:20px;overflow:hidden;">
        <!--        <span class="copyright">&nbsp;Jssor Slider 2009-2015</span>-->

        <div style="position:absolute;display:block;top:0px;right:5px;width:280px;height:40px;">
            <? include 'php/social_icons.php' ?>
        </div>
    </div>
